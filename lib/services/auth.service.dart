...
class AuthServices {
  ...
  static Future<int> getUserId() async {
    return LocalStorageService.prefs!.getInt(AppStrings.userIdKey) ?? -1;
  }

  static Future<bool> setUserId(int userId) async {
    return LocalStorageService.prefs!.setInt(AppStrings.userIdKey, userId);
  }

  static Future<double> getCommission() async {
    return LocalStorageService.prefs!.getDouble(AppStrings.commissionKey) ?? 0.0;
  }

  static Future<bool> setCommission(double commission) async {
    return LocalStorageService.prefs!.setDouble(AppStrings.commissionKey, commission);
  }
