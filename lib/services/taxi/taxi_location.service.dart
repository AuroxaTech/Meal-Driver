...
import 'package:driver/services/app_permission_handler.service.dart';
    ...
    myLocationListener = LocationService().getNewLocationStream().listen(
      (event) {
        ...
        if (driverMarker == null) {
          ...
          Set<Marker>? markers = taxiViewModel
              ?.taxiGoogleMapManagerService?.gMapMarkers
              .replaceFirstWhere(
                (marker) =>
                    marker.markerId ==
                    taxiViewModel!.taxiGoogleMapManagerService?.driverMarkerId,
              ...
              .toSet();
          if (null != markers) {
            taxiViewModel!.taxiGoogleMapManagerService?.gMapMarkers = markers;
          }
        } else {
          //update driver maker
