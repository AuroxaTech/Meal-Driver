...
import 'package:driver/services/taxi/taxi_polylines.service.dart';
import 'package:driver/services/taxi/taxi_trip_booking_code.service.dart';
import 'package:driver/view_models/taxi/taxi.vm.dart';
import 'package:driver/views/pages/taxi/widgets/statuses/arrived.view.dart';
import 'package:driver/views/pages/taxi/widgets/statuses/enroute.view.dart';
import 'package:driver/views/pages/taxi/widgets/statuses/pickup.view.dart';
  ...
  zoomToPickupLocation([LatLng? point]) async {
    ...
    taxiViewModel.taxiGoogleMapManagerService?.gMapMarkers.add(
      Marker(
        ...
        icon: taxiViewModel.taxiGoogleMapManagerService?.sourceIcon ?? BitmapDescriptor.defaultMarker,
   ...
   taxiViewModel.taxiGoogleMapManagerService?.removeMapMarker(dropoffMarkerId);
    taxiViewModel.taxiGoogleMapManagerService?.gMapMarkers.add(
      Marker(
        ...
        icon: taxiViewModel.taxiGoogleMapManagerService?.destinationIcon ?? BitmapDescriptor.defaultMarker,
        anchor: Offset(0.5, 0.5),
      ),
    );
    //
