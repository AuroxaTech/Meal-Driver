...
import 'package:driver/views/pages/order/widgets/basic_taxi_trip_info.view.dart';
import 'package:driver/views/pages/order/widgets/order_payment_info.view.dart';
import 'package:driver/widgets/base.page.dart';
import 'package:driver/widgets/cards/order_summary.dart';
...
class TaxiOrderDetailPage extends StatefulWidget {
  ...
  @override
  State<TaxiOrderDetailPage> createState() => _TaxiOrderDetailPageState();
}
