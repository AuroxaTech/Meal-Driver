...
import 'package:driver/constants/app_taxi_settings.dart';
...
import 'package:driver/view_models/taxi/new_taxi_order_alert.vm.dart';
...
class IncomingNewOrderAlert extends StatefulWidget {
  const IncomingNewOrderAlert(this.taxiViewModel, this.newTaxiOrder,
      {super.key});
  ...
  @override
  State<IncomingNewOrderAlert> createState() => _IncomingNewOrderAlertState();
}
