...
import 'package:driver/views/pages/taxi/widgets/taxi_amount.view.dart';
import 'package:driver/views/pages/taxi/widgets/taxi_contact.view.dart';
import 'package:driver/views/pages/taxi/widgets/taxi_customer.view.dart';
import 'package:driver/views/pages/taxi/widgets/taxi_drop_off.view.dart';
import 'package:driver/views/pages/taxi/widgets/taxi_eta.view.dart';
import 'package:driver/views/pages/taxi/widgets/taxi_pickup.view.dart';
import 'package:driver/views/pages/taxi/widgets/taxi_swipe.view.dart';
