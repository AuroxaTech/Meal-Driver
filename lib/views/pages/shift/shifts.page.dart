    ...
    return ViewModelBuilder<ShiftsViewModel>.reactive(
        ...
        builder: (context, model, child) {
          return Scaffold(
            ...
            body: CustomMapListView(
              canRefresh: true,
              canPullUp: true,
              //refreshController: model.refreshController,
              onRefresh: model.fetchShifts,
              onLoading: () => model.fetchShifts(initialLoading: false),
              isLoading: model.isBusy,
              dataSet: model.shifts,
              ...
              itemBuilder: (context, index) {
                String title = model.shifts.keys.toList()[index];
                List<Shift> shifts = model.shifts[title] ?? [];
                return ShiftListItem(
                  title: title,
                  shifts: shifts,
                  orderPressed: (Shift shift) => model.onShiftClick(shift),
                );
              },
