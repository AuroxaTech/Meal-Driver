...
import 'package:driver/traits/qrcode_scanner.trait.dart';
import 'package:driver/utils/utils.dart';
import 'package:driver/views/pages/auth/register.page.dart';
  ...
  handleDeviceLogin(ApiResponse apiResponse) async {
    try {
      if (apiResponse.hasError()) {
        ...
        await AuthServices.setUserId(user.id);
        await AuthServices.setCommission(user.commission);
