...
import 'package:driver/models/category.dart';
import 'package:driver/models/delivery_address.dart';
import 'package:driver/models/delivery_slot.dart';
import 'package:driver/models/menu.dart';
import 'package:driver/models/package_type_pricing.dart';
import 'package:driver/models/vendor_type.dart';
  ...
  factory Vendor.fromJson(Map<String, dynamic> json) {
    return Vendor(
      ...
      baseDeliveryFee: json["base_delivery_fee"] == null
          ? 0.00
          : double.tryParse(json["base_delivery_fee"].toString()) ?? 0.0,
