...
import 'package:driver/widgets/buttons/custom_leading.dart';
import 'package:driver/widgets/buttons/custom_outline_button.dart';
...
//
    return BasePage(
      ...
      elevation: 0,
      leading: const CustomLeading().onInkTap(() {
